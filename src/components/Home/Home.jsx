    ...
    <Container sx={{ marginTop: "2rem", marginBottom: "2rem" }}>
      ...
      <Box sx={{ display: "flex", justifyContent: "start", alignItems: "start", textAlign: "start", flexWrap: "wrap", flexDirection: "column" }}>
        ...
        <Box sx={{ marginTop: "1.5rem" }}>
          <Typography sx={{ fontFamily: "inherit", color: theme.palette.primary.contrastText, fontWeight: "900", fontSize: { xs: "2rem", md: "2rem", lg: "2.5rem" }, marginTop: { xs: "2rem", md: "2rem", lg: "0.5rem" } }}>
            Our Unique Approach
          </Typography>

          <Typography sx={{ fontFamily: "inherit", color: theme.palette.primary.contrastText, maxWidth: "840px", textAlign: "justify", fontWeight: "400", fontSize: "18px", marginTop: { xs: "1rem", md: "1rem", lg: "1rem" } }}>
